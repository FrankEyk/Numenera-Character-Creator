...
export class FocusService {
  ...
  private commandMentalPowersDesc = 
  ...
  foci: Focus[] = [
    {
      ...
      description: this.bearHaloFireDesc
    },
    {
      name: 'Commands Mental Powers',
      description: this.commandMentalPowersDesc
    }
  ];
   ...
   */
  setSelected(selectedFocus: Focus){
